...
const dictionaries: Record<Language, Translations> = {
  en: {
    ...
    scene1Desc: "Before you can cast your vote, you must be registered! If you are an Indian citizen and 18 years of age or older on the qualifying date, you are eligible. To register, you must fill out Form 6. You can do this online through the official Election Commission of India (ECI) Voter Portal or the Voter Helpline App. You will need proof of age and residence. Once processed by the Electoral Registration Officer (ERO), your name is added to the Electoral Roll and you will receive your EPIC (Electors Photo Identity Card) by post. You simply cannot vote without being on the roll, even if you have an Aadhaar card!",
    scene2Title: "Bring Your ID & Leave Mobile at Home",
    scene2Desc: "On polling day, you must verify your identity at the polling booth. Bring your Voter ID (EPIC), Aadhaar card, PAN card, Passport, or any of the 12 approved documents by ECI. Remember: Mobile phones, smartwatches, cameras, and any electronic gadgets are strictly prohibited inside the polling booth to maintain the absolute secrecy of your vote. Please leave them at home or hand them to a trusted person outside the 100-meter perimeter before entering.",
    scene3Title: "The Indelible Ink Verification",
    scene3Desc: "Once inside, the First Polling Officer checks your name on the electoral roll and verifies your ID aloud. Then, the Second Polling Officer marks your left forefinger with special indelible ink from the cuticle to the skin. This violet ink contains silver nitrate, reacts to sunlight, and cannot be washed off for several weeks, preventing duplicate voting. Finally, you will sign or provide a thumb impression in the Register of Voters (Form 17A) and receive a voter slip.",
    scene4Title: "Press The EVM Button",
    scene4Desc: "The Third Polling Officer takes your slip and enables the ballot. You will proceed to the voting compartment where the Electronic Voting Machine (EVM) is kept. The machine is completely standalone and disconnected from the internet. Find your preferred candidate and their symbol. Press the blue button directly next to their name. A red light will glow next to the button, and you will hear a loud, distinct BEEP sound confirming your choice has been recorded.",
    scene5Title: "Verify Your Choice (VVPAT)",
    scene5Desc: "Immediately after pressing the blue button, look through the transparent window of the VVPAT (Voter Verifiable Paper Audit Trail) machine kept right beside the EVM. A printed paper slip will appear showing the serial number, name, and symbol of the candidate you just voted for. It remains visible behind the glass for exactly 7 seconds before cutting automatically and dropping safely into the sealed drop box below. Your democratic duty is complete!"
  },
  hi: {
