...
export default function LanguageSelector() {
  ...
  return (
    <div className="relative group z-50">
      <button className="flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur-md border border-slate-200 rounded-full hover:bg-white/80 transition-colors shadow-sm">
